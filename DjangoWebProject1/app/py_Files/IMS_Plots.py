...
"""
pdf = matplotlib.backends.backend_pdf.PdfPages("C:\\Users\\supraja\\source\\repos\\DjangoWebProject1\\DjangoWebProject1\\pyt_Files\\pdf_Files\\Analysing_IMS_plots.pdf")
raw_KeyWords_List = []
src_Names = []
...
def ion_msg_service(data_file2, index):
    ...
    plt.xlabel('MessagingExceptionMapper')
    plt.ylabel('Frequency');
...
def get_Ims_plots(filepath):
    ...
    data_file2["dfile0"] = pd.read_csv(filepath, encoding='latin-1')
